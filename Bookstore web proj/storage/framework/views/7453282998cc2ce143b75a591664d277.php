    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
            ...
            <?php if(Auth::check() && auth()->user()->favorites->contains($book)): ?>
                <p></p>
                <span class="btn btn-warning disabled">Already in Favorites</span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\practiceBackupExport\practice\resources\views/books/show.blade.php ENDPATH**/ ?>